...
// var_dump('unchosen default widget of '.$this->_s_field_type);
			...
			$s_html .=					 	'<div class="attr-row">
												<label class="attr-name" for="'.$this->_s_field_type.'_field_label">'.__('Field Label', 'x2board').'</label>
			...
			if(!is_null($this->_a_roles)) {  // if(isset($item['roles'])) {
				$s_html .= 					'<div class="attr-row">
												<label class="attr-name" for="'.$this->_s_field_type.'_roles">'.__('Whom to display', 'x2board').'</label>
												<div class="attr-value">
			...
			if(!is_null($this->_s_secret_permission)) { // if(isset($item['secret_permission'])) {
				$s_html .=					'<div class="attr-row">
												<label class="attr-name" for="'.$this->_s_field_type.'_secret">'.__('Secret post', 'x2board').'</label>
												<div class="attr-value">
				...
				$s_html .=								'<option value="roles" '.$s_selected.'>'.__('Choose below', 'x2board').'</option>
													</select>';
			...
			if(!is_null($this->_s_notice_permission)) { // if(isset($item['notice_permission'])) {
				$s_html .=					'<div class="attr-row">
												<label class="attr-name" for="'.$this->_s_field_type.'-notice">'.__('Notice', 'x2board').'</label>
												<div class="attr-value">
