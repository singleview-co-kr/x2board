...
if ( ! class_exists( '\\X2board\\Includes\\Modules\\Editor\\editorView' ) ) {
	...
	class editorView extends editor {
		...
		public static function get_post_editor_html( $n_current_post_id, $s_placeholder = null ) {
			...
			unset( $o_editor_conf );
			wp_enqueue_script( X2B_DOMAIN . '-post-validation', X2B_URL . 'includes/modules/editor/js/post_validation.js', array( X2B_JQUERY_VALIDATION ), X2B_VERSION, true );
		...
		public static function get_comment_editor_html() {
			...
			wp_enqueue_script( X2B_DOMAIN . '-comment-validation', X2B_URL . 'includes/modules/editor/js/comment_validation.js', array( X2B_JQUERY_VALIDATION ), X2B_VERSION, true );
		}
