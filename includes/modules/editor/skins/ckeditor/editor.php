...
<!-- css -->
<?php wp_enqueue_style("x2board-ckeditor-default-style", X2B_URL . 'includes/modules/editor/skins/ckeditor/css/default.css', [], X2B_VERSION) ?>
...
<?php wp_enqueue_script('ckeditor-editor-common', X2B_URL . 'includes/modules/editor/tpl/js/editor_common.js', array(), X2B_VERSION, true)?>
<?php wp_enqueue_script('ckeditor-editor-app', X2B_URL . 'includes/modules/editor/tpl/js/editor.app.js', array(), X2B_VERSION, true)?>
<?php wp_enqueue_script('ckeditor-xe-interface', X2B_URL . 'includes/modules/editor/skins/ckeditor/js/xe_interface.js', array(), X2B_VERSION, true)?>
