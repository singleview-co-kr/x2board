...
if (!class_exists('\\X2board\\Includes\\Modules\\Board\\boardAdminModel')) {
	...
	class boardAdminModel {
		...
		public function get_latest_files() {
			require_once X2B_PATH . 'includes' . DIRECTORY_SEPARATOR . X2B_MODULES_NAME . DIRECTORY_SEPARATOR . 'file' . DIRECTORY_SEPARATOR . 'wp_admin_class' . DIRECTORY_SEPARATOR . 'wp_latest_files.php';
		...
		public function get_latest_comments() {
			require_once X2B_PATH . 'includes' . DIRECTORY_SEPARATOR . X2B_MODULES_NAME . DIRECTORY_SEPARATOR . 'comment' . DIRECTORY_SEPARATOR . 'wp_admin_class' . DIRECTORY_SEPARATOR . 'wp_latest_comments.php';
		...
		public function get_latest_posts() {
			require_once X2B_PATH . 'includes' . DIRECTORY_SEPARATOR . X2B_MODULES_NAME . DIRECTORY_SEPARATOR . 'post' . DIRECTORY_SEPARATOR . 'wp_admin_class' . DIRECTORY_SEPARATOR . 'wp_latest_posts.php';
